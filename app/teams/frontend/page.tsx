...
// Get team data
const team = teams.find(t => t.id === "frontend");

// Get all projects that are either directly in the Frontend team or have Frontend in teamIds
const teamProjects = allProjects.filter(p => 
  p.team === "frontend" || (p.teamIds && p.teamIds.includes("frontend"))
);
...
const teamMembers = team?.members.map((member, index) => ({
  ...
  bio: "Expert in frontend development and UI/UX design.",
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex flex-col w-full">
        {/* Hero section */}
        <section className={`w-full py-24 relative bg-gradient-to-br from-green-600 to-teal-600`}>
                  ...
                  <Card className="h-full flex flex-col">
                    <CardContent className="p-6 flex flex-col items-center text-center flex-grow">
                      <Avatar className="h-24 w-24 mb-4">
                        ...
                        <AvatarFallback className="text-2xl bg-green-500/10">{member.avatarFallback}</AvatarFallback>
                      </Avatar>
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Examples of our work in frontend development and UI/UX design
              </p>
            </div>
                        ...
                        <div className="p-6 bg-card">
                          ...
                          {project.teamIds && project.teamIds.length > 1 && (
                            <div className="mt-2 text-xs text-muted-foreground">
                              {project.teamIds.filter(id => id !== "frontend").map(id => {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Contact our Frontend team today to discuss how we can help bring your vision to life
              </p>
